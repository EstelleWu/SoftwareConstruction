...
public class GangesOrderShipper {
    ...
    public static void main(String[] args) {
        ...
        Book b1 = new StandardizedBook("The Unbearable Lightness of Being John Malkovich", 19.95);
        ...
        for (Book b : booksToShip) {
            ...
            String box_size = b.getMinBoxSize();
            Box box = b.packageBook(new Box(box_size));
            ...
            if (shipping > MAX_EXPECTED_SHIPPING && b.getMinBoxSize() == "medium") {
